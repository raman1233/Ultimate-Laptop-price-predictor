...
st.markdown("##### Fill in the specifications to estimate the market value")
st.write("---")

# --- Form Inputs inside Glassmorphism Layout ---
with st.container():
    # Wrap columns in a div for glass effect (conceptual via markdown or just use columns)
